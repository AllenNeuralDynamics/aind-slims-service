...
class SlimsEcephysData(BaseModel):
    ...
    animal_weight_prior: Optional[Annotated[str, Field(strict=True)]] = None
    animal_weight_after: Optional[Annotated[str, Field(strict=True)]] = None
    animal_weight_unit: Optional[StrictStr] = None
    reward_consumed: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    @field_validator('animal_weight_prior')
    def animal_weight_prior_validate_regular_expression(cls, value):
    ...
    @field_validator('animal_weight_after')
    def animal_weight_after_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('reward_consumed')
    def reward_consumed_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
