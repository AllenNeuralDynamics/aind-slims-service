...
class SlimsSpimData(BaseModel):
    ...
    chamber_refractive_index: Optional[Annotated[str, Field(strict=True)]] = None
    sample_refractive_index: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    @field_validator('chamber_refractive_index')
    def chamber_refractive_index_validate_regular_expression(cls, value):
    ...
    @field_validator('sample_refractive_index')
    def sample_refractive_index_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
