    ...
    def make_instance(self, include_optional) -> SlimsEcephysData:
        ...
        if include_optional:
            return SlimsEcephysData(
                ...
                session_name = '',
                animal_weight_prior = ERROR_TO_EXAMPLE_VALUE,
                animal_weight_after = ERROR_TO_EXAMPLE_VALUE,
                animal_weight_unit = '',
                reward_consumed = ERROR_TO_EXAMPLE_VALUE,
                ...
                stream_modules = ERROR_TO_EXAMPLE_VALUE,
                daq_names = [
                    ''
                    ],
                camera_names = [
