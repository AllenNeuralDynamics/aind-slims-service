...
class SlimsViralMaterialData(BaseModel):
    ...
    dose: Optional[Annotated[str, Field(strict=True)]] = None
    dose_unit: Optional[StrictStr] = None
    titer: Optional[Annotated[str, Field(strict=True)]] = None
    titer_unit: Optional[StrictStr] = None
    volume: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    def dose_validate_regular_expression(cls, value):
    ...
    @field_validator('titer')
    def titer_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
