...
class SlimsWaterRestrictionData(BaseModel):
    ...
    target_weight_fraction: Optional[Annotated[str, Field(strict=True)]] = None
    baseline_weight: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    @field_validator('target_weight_fraction')
    def target_weight_fraction_validate_regular_expression(cls, value):
    ...
    @field_validator('baseline_weight')
    def baseline_weight_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
