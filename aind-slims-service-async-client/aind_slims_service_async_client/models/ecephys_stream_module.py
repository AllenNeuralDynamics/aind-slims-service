...
class EcephysStreamModule(BaseModel):
    ...
    arc_angle: Optional[Annotated[str, Field(strict=True)]] = None
    module_angle: Optional[Annotated[str, Field(strict=True)]] = None
    rotation_angle: Optional[Annotated[str, Field(strict=True)]] = None
    coordinate_transform: Optional[StrictStr] = None
    ccf_coordinate_ap: Optional[Annotated[str, Field(strict=True)]] = None
    ccf_coordinate_ml: Optional[Annotated[str, Field(strict=True)]] = None
    ccf_coordinate_dv: Optional[Annotated[str, Field(strict=True)]] = None
    ccf_coordinate_unit: Optional[StrictStr] = None
    ccf_version: Optional[StrictStr] = None
    bregma_target_ap: Optional[Annotated[str, Field(strict=True)]] = None
    bregma_target_ml: Optional[Annotated[str, Field(strict=True)]] = None
    bregma_target_dv: Optional[Annotated[str, Field(strict=True)]] = None
    bregma_target_unit: Optional[StrictStr] = None
    surface_z: Optional[Annotated[str, Field(strict=True)]] = None
    surface_z_unit: Optional[StrictStr] = None
    manipulator_x: Optional[Annotated[str, Field(strict=True)]] = None
    manipulator_y: Optional[Annotated[str, Field(strict=True)]] = None
    manipulator_z: Optional[Annotated[str, Field(strict=True)]] = None
    ...
    @field_validator('arc_angle')
    def arc_angle_validate_regular_expression(cls, value):
    ...
    @field_validator('module_angle')
    def module_angle_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def rotation_angle_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('ccf_coordinate_ap')
    def ccf_coordinate_ap_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('ccf_coordinate_ml')
    def ccf_coordinate_ml_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('ccf_coordinate_dv')
    def ccf_coordinate_dv_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('bregma_target_ap')
    def bregma_target_ap_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('bregma_target_ml')
    def bregma_target_ml_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('bregma_target_dv')
    def bregma_target_dv_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('surface_z')
    def surface_z_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('manipulator_x')
    def manipulator_x_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('manipulator_y')
    def manipulator_y_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('manipulator_z')
    def manipulator_z_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
